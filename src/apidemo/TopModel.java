...
class TopModel extends AbstractTableModel {
	...
	@Override public String getColumnName(int col) {
		switch( col) {
			...
			case 9: return "ImpVol";
			case 10:return "Delta";
			case 11:return "Gamma";
			case 12:return "Vega";
			case 13:return "Theta";
			default: return null;
		}
	}
	...
	@Override public Object getValueAt(int rowIn, int col) {
		...
		switch( col) {
			...
			case 9: return fmtPct( row.m_impVol);
			case 10: return fmtNz( row.m_delta);
			case 11: return fmtNz( row.m_gamma);
			case 12: return fmtNz( row.m_vega);
			case 13: return fmtNz( row.m_theta);
			default: return null;
		}
	}
	...
	static class TopRow implements IOptHandler {
		...
		@Override public void tickOptionComputation( NewTickType tickType, double impVol, double delta, double optPrice, double pvDividend, double gamma, double vega, double theta, double undPrice) {
			if (tickType == NewTickType.MODEL_OPTION) {
				...
				m_vega = vega;
				m_theta = theta;
				System.out.println("调用TopModel中的tickOptionComputation;impVol:"+impVol+";delta:"+delta+";optPrice:"+optPrice+";gamma:"+gamma+";vega:"+vega+";theta:"+theta);
				m_model.fireTableDataChanged();
			}
		}
