...
public class ApiController implements EWrapper {
    ...
    public void reqOptionMktData(NewContract contract, String genericTickList, boolean snapshot, IOptHandler handler) {
    	...
    	System.out.println("ApiController.reqOptionMktData();reqId="+reqId+";contractDescription="+contract.description());
    	m_client.reqMktData( reqId, contract.getContract(), genericTickList, snapshot);
		sendEOM();
    }
	...
	// zk modify: return the orderId
	public int placeMyModifyOrder(NewContract contract, final NewOrder order, final IOrderHandler handler) {
		if (order.orderId() == 0) {
